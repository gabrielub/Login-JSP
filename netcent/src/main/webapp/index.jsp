...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Netcentric Computing</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#group1">Group Members</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To A Health Site</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Health Reports - On-site Checkup - Free Medical Test</p>
		</div>
	</header>
	<!-- Portfolio Section-->
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Paediatrics Section</h2>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">The group's task is to create a login page and validate. This was achieved by creating login servlets, using db connector from JAR with JDBC and MySQL</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Check your health today!</p>
				</div>
			</div>
			<!-- About Section Button-->
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href="https://www.bing.com/ck/a?!&&p=cd9818771bed305eJmltdHM9MTcyNDAyNTYwMCZpZ3VpZD0xZWI4NDQwMC00YjZjLTY5NjctMDNkNC01N2I3NGEwMDY4MDUmaW5zaWQ9NTIzMw&ptn=3&ver=2&hsh=3&fclid=1eb84400-4b6c-6967-03d4-57b74a006805&psq=health+brochures&u=a1aHR0cHM6Ly93d3cubnV0cml0aW9uLmdvdi90b3BpY3MvYmFzaWMtbnV0cml0aW9uL3ByaW50YWJsZS1tYXRlcmlhbHMtYW5kLWhhbmRvdXRz&ntb=1"> <i
					class="fas fa-download me-2"></i>Download Free Health Brochures!
				</a>
			</div>
		</div>
	</section>
	...
	<section class="page-section" id="contact">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">For a Doctor's Appointment</h2>
			<!-- Icon Divider-->
			<div class="divider-custom">
				<div class="divider-custom-line"></div>
				<div class="divider-custom-icon">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					<h4 class="text-uppercase mb-4">L</h4>
					<p class="lead mb-0">
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Course &copy; Netcentric Computing</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
